    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="page-header">${studentName} - Recommendations for semester: SPRING Jan 6th - May 6th 2016</h1>
        ...
        <g:form action="submitForm" controller="Recommendations ">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12" align="right">
                        ...
                        <g:actionSubmit class="btn btn-success btn-lg" value="Go back" action="goback"  />
