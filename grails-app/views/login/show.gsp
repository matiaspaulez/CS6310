	...
	<body>
		...
		<div id="show-login" class="content scaffold-show" role="main">
			...
			<ol class="property-list login">
				...
				<g:if test="${loginInstance?.users}">
				<li class="fieldcontain">
					<span id="users-label" class="property-label"><g:message code="login.users.label" default="Users" /></span>
					
						<g:each in="${loginInstance.users}" var="u">
